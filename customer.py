...
class Customer:
	...
	def __init__(self, _data):
		...
		self.interpolate = Interpolate([100000, 150000, 200000, 250000, 300000, 350000],
	...
	def calculate(self):
		...
		self.dwelling_coverage_rating_factor_value = self.interpolate[self.dwelling_coverage]
